...
"""
platform-global-teacher-campus documentation build configuration file.
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'platform_global_teacher_campus.settings.test'
django_setup()
...
html_context = {
    ...
    "github_repo": 'platform-global-teacher-campus',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/eduNEXT/platform-global-teacher-campus",
...
#
# html_title = 'platform-global-teacher-campus v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Initial Course Validation Workflow plugin',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'platform_global_teacher_campus'),
                os.path.join(root_path, 'platform_global_teacher_campus/migrations')])

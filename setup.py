#!/usr/bin/env python
"""
Package metadata for platform_global_teacher_campus.
"""
import os
import re
import sys
...
VERSION = get_version('platform_global_teacher_campus', '__init__.py')
...
setup(
    name='platform-global-teacher-campus',
    version=VERSION,
    description="""Initial Course Validation Workflow plugin""",
    long_description=README + '\n\n' + CHANGELOG,
    author='andres espinel',
    author_email='andres.espinel@edunext.co',
    url='https://github.com/eduNEXT/platform-global-teacher-campus',
    packages=find_packages(
        include=['platform_global_teacher_campus', 'platform_global_teacher_campus.*'],
        exclude=["*tests"],
    ),
